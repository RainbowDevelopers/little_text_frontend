...
export default function PostHero({ post }: PostHeroProps) {
  ...
  return (
    <div className="space-y-8 md:space-y-12">
      ...
      {/* Title */}
      <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black dark:text-white text-center leading-tight max-w-4xl mx-auto">
        {post.title}
      </h1>
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 md:gap-6 text-sm md:text-base text-gray-600 dark:text-gray-400">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-black dark:text-white">{post.author.name}</span>
        </div>
